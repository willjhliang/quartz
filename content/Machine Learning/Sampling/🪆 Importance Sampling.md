Importance sampling is a form of [[🤔 Monte Carlo Sampling]] that uses an alternate distribution $q(x)$ in case $p(x)$ requires too many samples for an accurate estimate. Since we can write 
$$
